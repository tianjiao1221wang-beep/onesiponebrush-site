...
export interface WorkshopSeriesSectionProps {
  bottomCtaText?: string;
  bottomCtaSubtext?: string;
  showQuickNav?: boolean;
}

const WorkshopSeriesSection: React.FC<WorkshopSeriesSectionProps> = ({
  bottomCtaText = 'Ready to bring Chinese heritage crafts to your event?',
  bottomCtaSubtext,
  showQuickNav = true,
}) => (
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        ...
        <p className="text-stone-500 text-sm max-w-2xl mx-auto">
          Find the right workshop for your audience. Each series offers age-appropriate options from K–5 through adult.
        </p>
      </div>
      ...
      <div className="mt-16 pt-16 border-t border-stone-200 text-center">
        <p className="text-stone-600 mb-4">{bottomCtaText}</p>
        {bottomCtaSubtext && <p className="text-sm text-stone-500 mb-4">{bottomCtaSubtext}</p>}
        <Link
          to="/contact"
...
export default WorkshopSeriesSection;
