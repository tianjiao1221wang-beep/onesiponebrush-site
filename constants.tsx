...
export const PRODUCTS: Product[] = [
  {
    ...
    price: 0.5,
    description: 'Test item for payment flow. $0.50 only. For testing purposes.',
    chineseDescription: '用于测试支付流程的商品，仅 $0.50。测试用途。',
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'camellia', name: 'Butterfly Camellia', chineseName: '蝴蝶山茶水扇', image: '/images/product-water-fan-camellia.png' },
    ]
  },
  {
    id: '14',
